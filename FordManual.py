...
def get_wiring_params(session: dict) -> dict:
    ...
    while True:
        ...
        # Grab cookies — two sources needed
        print()
        hr()
        print("  Now we need session cookies from two requests.")
        print()
        print("  FIRST — PTS cookies from fordtechservice.dealerconnection.com:")
        print()
        print("  Instructions:")
        print("  1. In the Network tab, find the TableOfContents (plural, with 's')")
        print("     request to fordtechservice.dealerconnection.com")
        ...
        print(f"  5. Paste it into cookies.txt:")
        print(f"       {COOKIE_FILE}")
        print()
        print("  TIP: On Windows:  notepad \"" + str(COOKIE_FILE) + "\"")
        print("  On Mac:           open -e '" + str(COOKIE_FILE) + "'")
        print()
        pause("  Press Enter once you've saved the first cookie block...")
        print()
        hr()
        print()
        print("  SECOND — content server cookies from fordservicecontent.com:")
